...
### Company List
The company list provides a high-level overview of all organizations in your CRM.

![RealTimeX CRM Company List](../../images/companies-list.png)

### Company Detail
The detail view shows all information related to a specific company, including its activity log, contacts, and notes.

![RealTimeX CRM Company Detail](../../images/companies-detail.png)
ector, size, or account manager.
