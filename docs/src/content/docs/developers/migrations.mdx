---
title: Migrations
description: This document explains how to create and manage database migrations in RealTimeX CRM.
---
...
If you change the data structure for a contact, don't forget to modify the sample CSV file located at [`src/components/atomic-crm/contacts/contacts_export.csv`](https://github.com/therealtimex/realtimex-crm/blob/main/src/components/atomic-crm/contacts/contacts_export.csv). You'll also need to modify the import function found in [`src/components/atomic-crm/contacts/useContactImport.tsx`](https://github.com/therealtimex/realtimex-crm/blob/main/src/components/atomic-crm/contacts/useContactImport.tsx).
